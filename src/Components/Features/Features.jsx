...
const Features = () => {
  ...
  return (
    <div id="body">
    <div id="viewport"> 
    <button id="hbt"><a href="/">Home</a></button>
    <div id="world"> 
     ...
     <div className="features"> 
      ...
      <div className="f2 ">
      <img src="src\assets\f2-removebg-preview.png" />
      </div> 
      <div className="f3 ">
      <img src="src\assets\f3-removebg-preview.png" />
      </div> 
      <div className="f4 ">
      <img src="src\assets\f4-removebg-preview.png" />
      </div> 
      <div className="f5">
...
function init(){
  ...
  var pathd = "M"+worldw+",0C"+worldwhalf+","+worldh/0.8+","+worldwhalf/3+","+worldh/3+",0,0";
          console.log(pathd);
          $("#path").attr("d", pathd);
